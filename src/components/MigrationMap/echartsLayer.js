  ...
  return esriLoader.loadModules(
    ...
    ([declare,
      ...
      constructor: function(view, option) {
        option.registerCoordinateSystem('arcgis', this.getE3CoordinateSystem(view))
        this.init(view, option)
      },
      init: function(view, option) {
        this.setBaseMap(view)
        this.createLayer(option)
      ...
      setCharts: function() {
        ...
        const baseExtent = this.view.extent
