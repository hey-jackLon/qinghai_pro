...
gaodeLayer.create = function(map) {
  esriLoader.loadModules(['dojo/_base/declare',
  ...
  function(declare,
    ...
    declare('GaoDeLayer', TiledMapServiceLayer, {
      ...
      getTileUrl: function(level, row, col) {
        const url = 'http://webrd0' + (col % 4 + 1) + '.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x=' + col + '&y=' + row + '&z=' + level
        return url
      }
    })

    function loadLayer(map) {
      const gaoLayer = new GaoDeLayer()
