  ...
  <div>
    <el-table :data="tableData" height="400" border style="width: 100%" @current-change="handleCurrentChange">
      ...
      <el-table-column label="客车">
        ...
        <el-table-column prop="TB_KC" width="100" label="总流量同比" />
        <el-table-column prop="HB_KC" width="100" label="总流量环比" />
      ...
      <el-table-column label="大客车">
        ...
        <el-table-column prop="TB_DKC" width="100" label="总流量同比" />
        <el-table-column prop="HB_DKC" width="100" label="总流量环比" />
      ...
      <el-table-column label="小客车">
        ...
        <el-table-column prop="TB_XKC" width="100" label="总流量同比" />
        <el-table-column prop="HB_XKC" width="100" label="总流量环比" />
